import { ExternalLink, Heart, Code, Users, FileText } from "lucide-react";
...
const Footer = () => {
  ...
  const links = {
    ...
    resources: [
      ...
      {
        name: "Documentation",
        href: "https://github.com/saigontechnology/AgentCrew#readme",
        external: true,
      },
      {
        name: "Examples",
        href: "https://github.com/saigontechnology/AgentCrew/tree/main/examples",
        external: true,
      },
      {
        name: "Issues & Support",
        href: "https://github.com/saigontechnology/AgentCrew/issues",
        external: true,
      },
    ],
    community: [
      {
        name: "Contribute",
        href: "https://github.com/saigontechnology/AgentCrew/blob/main/CONTRIBUTING.md",
        external: true,
      },
      {
        name: "Star on GitHub",
      ...
      {
        name: "Report Issues",
        href: "https://github.com/saigontechnology/AgentCrew/issues/new",
        external: true,
      },
      {
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {stats.map((stat, index) => (
              ...
              >
                <div className="p-2 bg-primary-500 rounded-lg">{stat.icon}</div>
                <div>
