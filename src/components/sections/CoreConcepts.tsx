      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            AgentCrew is built on three fundamental principles that make AI collaboration 
            ...
            >
              ...
              <div className="flex-1 space-y-6">
                <div className="flex items-center space-x-4">
                  <div className={`p-4 rounded-2xl bg-gradient-to-br ${concept.color} text-white`}>
                    {concept.icon}
                  </div>
                ...
                <div className="bg-white rounded-2xl shadow-xl p-8">
                  {index === 0 && (
                    <div className="space-y-4">
                      <div className="text-center text-gray-700 font-semibold mb-6">Agent Specialization</div>
                      <div className="grid grid-cols-2 gap-4">
                        <div className="bg-blue-100 p-4 rounded-lg text-center">
                          <div className="w-8 h-8 bg-blue-500 rounded-full mx-auto mb-2"></div>
                          <div className="text-sm font-medium text-blue-700">Research Agent</div>
                        </div>
                        <div className="bg-green-100 p-4 rounded-lg text-center">
                          <div className="w-8 h-8 bg-green-500 rounded-full mx-auto mb-2"></div>
                          <div className="text-sm font-medium text-green-700">Writing Agent</div>
                        </div>
                        <div className="bg-purple-100 p-4 rounded-lg text-center">
                          <div className="w-8 h-8 bg-purple-500 rounded-full mx-auto mb-2"></div>
                          <div className="text-sm font-medium text-purple-700">Code Agent</div>
                        </div>
                        <div className="bg-orange-100 p-4 rounded-lg text-center">
                          <div className="w-8 h-8 bg-orange-500 rounded-full mx-auto mb-2"></div>
                          <div className="text-sm font-medium text-orange-700">Analysis Agent</div>
                        </div>
                      </div>
                    </div>
                  )}
                  ...
                  {index === 1 && (
                    <div className="space-y-6">
                      <div className="text-center text-gray-700 font-semibold mb-6">Task Flow</div>
                      <div className="space-y-4">
                        <div className="flex items-center space-x-3">
                          <div className="w-8 h-8 bg-blue-500 rounded-full flex items-center justify-center text-white text-sm font-bold">1</div>
                          <div className="flex-1 bg-blue-100 p-3 rounded-lg text-blue-700 text-sm">Research Task</div>
                        </div>
                        ...
                        <div className="flex items-center space-x-3">
                          ...
                          <div className="flex-1 bg-purple-100 p-3 rounded-lg text-purple-700 text-sm">Analysis Task</div>
                        </div>
                        <div className="flex justify-center">
                          <ArrowRightLeft className="w-6 h-6 text-gray-400" />
                        </div>
                        <div className="flex items-center space-x-3">
                          ...
                          <div className="flex-1 bg-green-100 p-3 rounded-lg text-green-700 text-sm">Writing Task</div>
                        </div>
                      </div>
                    </div>
                  )}
                  ...
                  {index === 2 && (
                    <div className="space-y-4">
                      <div className="text-center text-gray-700 font-semibold mb-6">AI Model Flexibility</div>
