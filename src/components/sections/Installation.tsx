...
const Installation = () => {
  ...
  const quickInstallCommands = {
    linux: 'curl -LsSf https://gist.githubusercontent.com/daltonnyx/aa45d64fd8fb6a084067d4012a5710a6/raw/116f24fe3d94f0c1a972da92cac2f278a59fdad6/install.sh | bash',
    windows: 'powershell -ExecutionPolicy ByPass -c "irm https://gist.githubusercontent.com/daltonnyx/e2d9a4d371e095bfa07cf5246d7e0746/raw/af138f99ed5351dc59cae81143e058ef95b5fa37/install.ps1 | iex"'
  }
  ...
  const prerequisites = [
    ...
    { name: 'uv package manager', description: 'Fast Python package manager (pip install uv)' },
  ...
  return (
    <section id="installation" className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Prerequisites */}
        <div className="mb-12">
          <h3 className="text-2xl font-bold text-gray-900 mb-6 text-center">Prerequisites</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {prerequisites.map((prereq, index) => (
              <div key={index} className="bg-white p-4 rounded-lg border border-gray-200 text-center">
                <div className="font-semibold text-gray-900 mb-1">{prereq.name}</div>
                <div className="text-sm text-gray-600">{prereq.description}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="p-8">
            {activeTab === 'quick' && (
              <div className="space-y-8">
                <div className="text-center mb-8">
                  <h3 className="text-xl font-bold text-gray-900 mb-2">One-Command Installation</h3>
                  <p className="text-gray-600">Choose your operating system and run the command</p>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-gray-900 rounded-lg p-4 relative">
                    ...
                    <button
                      onClick={() => copyToClipboard(quickInstallCommands.linux, 'linux')}
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-gray-900 rounded-lg p-4 relative">
                    ...
                    <button
                      onClick={() => copyToClipboard(quickInstallCommands.windows, 'windows')}
                      className="absolute top-4 right-4 p-2 bg-gray-800 hover:bg-gray-700 rounded-lg transition-colors duration-200"
                    >
                  ...
                  <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 flex items-start space-x-3">
                    ...
                    <div className="text-sm text-yellow-800">
                      <strong>Note:</strong> The Windows script is AI-generated and may need testing. 
            ...
            {activeTab === 'standard' && (
              <div className="space-y-8">
                <div className="text-center mb-8">
                  <h3 className="text-xl font-bold text-gray-900 mb-2">Step-by-Step Installation</h3>
                  <p className="text-gray-600">Manual installation for all platforms</p>
                </div>
                  ...
                  {standardCommands.map((command, index) => (
                    <div key={index} className="flex items-center space-x-4">
                      ...
                      <div className="flex-1 bg-gray-900 rounded-lg p-4 relative">
                        ...
                        <button
                          onClick={() => copyToClipboard(command, `standard-${index}`)}
                          className="absolute top-4 right-4 p-2 bg-gray-800 hover:bg-gray-700 rounded-lg transition-colors duration-200"
                        >
        ...
        <div className="mt-16 bg-white rounded-2xl shadow-xl overflow-hidden">
          <div className="bg-gradient-to-r from-primary-500 to-primary-700 p-6 text-white">
            ...
            <p className="text-primary-100">Common commands to get you started</p>
          </div>
        ...
        <div className="mt-16 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
              ...
              <p className="text-gray-600 text-sm">Set up your AI provider credentials through the GUI or environment variables</p>
            </div>
            <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
              <Terminal className="w-8 h-8 text-primary-600 mx-auto mb-4" />
              <h4 className="font-semibold text-gray-900 mb-2">Create Your First Agent</h4>
              <p className="text-gray-600 text-sm">Define specialized agents with custom prompts and tools using the configuration interface</p>
            </div>
            <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
              <Play className="w-8 h-8 text-primary-600 mx-auto mb-4" />
              <h4 className="font-semibold text-gray-900 mb-2">Start Building</h4>
              <p className="text-gray-600 text-sm">Begin creating AI workflows and experience the power of collaborative agents</p>
            </div>
          </div>
        </div>
      </div>
